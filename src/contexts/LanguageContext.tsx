...
const translations = {
  tr: {
    ...
    "auth.signup.loading": "Kayıt oluşturuluyor...",
    "auth.signin.error": "Email veya şifre hatalı!",
    "auth.signin.unexpectedError": "Beklenmeyen bir hata oluştu.",
    "auth.signin.genericError": "Bir hata oluştu. Lütfen tekrar deneyin.",
    "auth.signup.passwordMismatch": "Şifreler eşleşmiyor!",
    "auth.signup.passwordMinLength": "Şifre en az 6 karakter olmalıdır!",
    "auth.signup.registerError": "Kayıt sırasında bir hata oluştu.",
    "auth.signup.genericError": "Bir hata oluştu. Lütfen tekrar deneyin.",
    "auth.signup.successMessage": "Kayıt başarılı! Giriş yapabilirsiniz.",
    "auth.backToHome": "Ana sayfaya dön",
    "auth.emailPlaceholder": "ornek@email.com",
    "auth.namePlaceholder": "Adınız Soyadınız",
    ...
    // Team Chat
    "teamChat.title": "Takım Sohbeti",
    "teamChat.aiChat": "AI Sohbet",
    "teamChat.signOut": "Çıkış Yap",
    "teamChat.pendingRequest": "Katılım isteğiniz gönderildi. Yönetici onayı bekleniyor.",
    "teamChat.teamInfo": "Takım Bilgileri",
    "teamChat.members": "Üyeler",
    "teamChat.person": "kişi",
    "teamChat.message": "mesaj",
    "teamChat.created": "Oluşturuldu:",
    "teamChat.teamMembers": "Takım Üyeleri",
    "teamChat.removeUser": "kullanıcısını çıkar",
    "teamChat.adminPanel": "Admin Paneli",
    "teamChat.notifications": "Bildirimler",
    "teamChat.deleteAllMessages": "Tüm mesajları sil",
    "teamChat.deleteAll": "Tümünü Sil",
    "teamChat.delete": "Sil",
    "teamChat.writeMessage": "Mesaj yazın...",
    "teamChat.noMessages": "Henüz mesaj yok",
    "teamChat.sendFirstMessage": "İlk mesajı siz gönderin!",
    "teamChat.deleteMessage": "Mesajı sil",
    "teamChat.noNotifications": "Henüz bildirim yok",
    "teamChat.role.admin": "Yönetici",
    "teamChat.role.mentor": "Mentor",
    "teamChat.role.member": "Üye",
    "teamChat.deleteConfirm": "Bu mesajı silmek istediğinizden emin misiniz?",
    "teamChat.deleteAllConfirm": "TÜM MESAJLARI silmek istediğinizden emin misiniz?\n\nBu işlem geri alınamaz!",
    "teamChat.removeMemberConfirm": "kullanıcısını takımdan çıkarmak istediğinizden emin misiniz?",
    "teamChat.errorDeletingMessages": "Mesajlar silinirken hata oluştu.",
    "teamChat.goToTeam": "Takıma Git",
    "teamChat.sendJoinRequest": "Katılım İsteği Gönder",
    "teamChat.joinRequestMessage": "Neden bu takıma katılmak istediğinizi açıklayın...",
    "teamChat.send": "Gönder",
    "teamChat.memberRemoved": "Üye başarıyla çıkarıldı.",
  ...
  en: {
    ...
    "auth.signin.error": "Email or password incorrect!",
    ...
    "auth.signup.passwordMinLength": "Password must be at least 6 characters!",
    "auth.signup.registerError": "An error occurred during registration.",
    "auth.signup.genericError": "An error occurred. Please try again.",
    "auth.signup.successMessage": "Registration successful! You can sign in.",
    ...
    "teamChat.aiChat": "AI Chat",
    "teamChat.signOut": "Sign Out",
    "teamChat.pendingRequest": "Your join request has been sent. Waiting for admin approval.",
    "teamChat.teamInfo": "Team Information",
    "teamChat.members": "Members",
    "teamChat.person": "people",
    "teamChat.message": "messages",
    "teamChat.created": "Created:",
    "teamChat.teamMembers": "Team Members",
    "teamChat.removeUser": "remove user",
    "teamChat.adminPanel": "Admin Panel",
    "teamChat.notifications": "Notifications",
    "teamChat.deleteAllMessages": "Delete all messages",
    "teamChat.deleteAll": "Delete All",
    "teamChat.delete": "Delete",
    "teamChat.writeMessage": "Write a message...",
    "teamChat.noMessages": "No messages yet",
    "teamChat.sendFirstMessage": "Send the first message!",
    "teamChat.deleteMessage": "Delete message",
    "teamChat.noNotifications": "No notifications yet",
    "teamChat.role.admin": "Admin",
    "teamChat.role.mentor": "Mentor",
    "teamChat.role.member": "Member",
    "teamChat.deleteConfirm": "Are you sure you want to delete this message?",
    "teamChat.deleteAllConfirm": "Are you sure you want to delete ALL MESSAGES?\n\nThis action cannot be undone!",
    "teamChat.removeMemberConfirm": "remove this user from the team?",
    "teamChat.errorDeletingMessages": "An error occurred while deleting messages.",
    "teamChat.goToTeam": "Go to Team",
    "teamChat.sendJoinRequest": "Send Join Request",
    "teamChat.joinRequestMessage": "Explain why you want to join this team...",
    "teamChat.send": "Send",
    "teamChat.memberRemoved": "Member removed successfully.",
