...
export default function CodeSnippetsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 transition-colors">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-2">
              ...
              <Link
                href="/chat"
                className="px-3 py-2 text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors text-sm font-medium hidden md:inline-flex items-center space-x-1"
                title="Chat"
              >
      ...
      {/* Hero Section */}
      <section className="py-12 lg:py-16 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-950 transition-colors">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center space-x-2 px-4 py-2 bg-white dark:bg-gray-900 rounded-full mb-6 shadow-sm border border-gray-200 dark:border-gray-700">
              <Sparkles className="w-4 h-4 text-purple-600" />
                <span className="text-sm font-medium text-gray-700 dark:text-gray-200">{language === "tr" ? "WPILib Kod Kütüphanesi" : "WPILib Code Library"}</span>
            </div>
            ...
            <div className="relative max-w-2xl mx-auto">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-4 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent shadow-sm transition-all"
              />
            </div>
          </div>
        </div>
      ...
      <section className="py-8 bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 transition-colors">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap items-center gap-3">
            <span className="text-sm font-semibold text-gray-700 dark:text-gray-200">Filtrele:</span>
            ...
            <select
              ...
              className="px-4 py-2 bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg text-gray-700 dark:text-gray-200 text-sm font-medium focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
            >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          {snippets.length === 0 ? (
            <div className="text-center py-16">
              ...
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Henüz snippet bulunmuyor</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-8">İlk kod örneğini siz oluşturun!</p>
              <Link
                href="/code-snippets/new"
                ...
                >
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex-1">
                      ...
                      {snippet.description && (
                        <p className="text-sm text-gray-600 dark:text-gray-300 mb-3">{snippet.description}</p>
                      )}
                      <div className="flex items-center gap-2 flex-wrap">
                        <span className="px-3 py-1 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/30 dark:to-purple-900/30 border border-blue-200 dark:border-blue-700 rounded-lg text-blue-700 dark:text-blue-300 text-xs font-semibold">
                          {snippet.category}
                        </span>
                        <span className="px-3 py-1 bg-gray-100 dark:bg-gray-800 rounded-lg text-gray-700 dark:text-gray-200 text-xs font-medium">
                          {snippet.language}
                        </span>
                      </div>
                    </div>
                  ...
                  {/* Code Preview */}
                  <div className="bg-gray-50 dark:bg-gray-950 rounded-xl p-4 mb-4 max-h-48 overflow-hidden relative group/code">
                    <pre className="text-sm text-gray-800 dark:text-gray-100 font-mono overflow-x-auto">
                      <code>{snippet.code.substring(0, 300)}{snippet.code.length > 300 ? '...' : ''}</code>
                    </pre>
                    <div className="absolute inset-x-0 bottom-0 h-12 bg-gradient-to-t from-gray-50 dark:from-gray-950 to-transparent"></div>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="p-2 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-lg text-gray-600 dark:text-gray-200 transition-colors"
                        title="Kodu kopyala"
                      >
                        {copiedId === snippet.id ? (
